...
if [ "$#" -gt 0 ]; then
  ...
  TESTS=(audit audit2 earlybal combat allareas fightsmoke fullbal econ settings-boxes savecompat saveslots actionlock freeactions perkcoverage titles titlepicker dojo cultivation places wiki marketplace ids capreach areagate)
fi
